...
def add_to_dict(dic, key, value=None):
    if str(type(dic)) != "<class 'dict'>":
        print("You need to send dictionary." + "You sent: " + str(type(dic)))
    elif value is None:
        print("You neet to send a word and definition")
    else:
        if key in dic.keys():
            print(key+" is already on the dictionary. Won't added")
        else:
            dic[key] = value
...
def update_word(dic, key=None, value=None):
    if str(type(dic)) != "<class 'dict'>":
        print("You need to send dictionary." + "You sent: " + str(type(dic)))
    elif value is None:
